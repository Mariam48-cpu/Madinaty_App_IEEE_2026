...
class AIPlannerRepositoryImpl implements AIPlannerRepository {
  ...
  Future<AIPlanEntity> createPlan(AIPlanRequestEntity request) async {
    ...
    // ------------------------------------------------------------
    // 2. Understand user's request using Gemini
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 4. Get real nearby cafes/places
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 5. Pre-rank real places
    // ------------------------------------------------------------
    final preRanked = _preRank(nearby, intent.requirements, position);

    // ------------------------------------------------------------
    // 6. Build candidates using real menu data
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 7. Let Gemini rank ONLY real candidates
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 8. Map Gemini results back to real CafeEntity objects
    // ------------------------------------------------------------
    ...
    for (final dto in finalDto.activities) {
      ...
      // Gemini returned a place that does not exist
      // in our real candidates.
    ...
    // ------------------------------------------------------------
    // 9. Fallback if Gemini returned no valid activities
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 10. Calculate final estimated total from real places
    // ------------------------------------------------------------
  ...
  Future<List<Map<String, dynamic>>> _buildCandidates(
    ...
    for (final cafe in cafes) {
      ...
      try {
        ...
        // If menu cannot be loaded,
        // keep estimatedCost = 0.
      }
