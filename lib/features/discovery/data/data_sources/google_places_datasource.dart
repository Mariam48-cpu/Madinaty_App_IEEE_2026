...
class GooglePlacesDataSource {
  ...
  Future<List<CafeDto>> getNearbyCafes({
    ...
    final response = await http.post(
      ...
      headers: {
        ...
        // 👈 تم إضافة places.photos هنا لتصل صور الكافيهات المجاورة تلقائياً!
        'X-Goog-FieldMask':
    ...
    print('GOOGLE PLACES STATUS: ${response.statusCode}');
    ...
    print('GOOGLE PLACES COUNT: ${places.length}');
  ...
  Future<List<CafeDto>> searchCafes({required String query}) async {
    ...
    print('Google Search Response: ${response.body}');
